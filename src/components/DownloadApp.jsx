    ...
    <div className=" p-8 pb-28">
      <h3
        className={cn(
          ...
          "uppercase text-[1.7rem] text-center md:text-left md:text-[3rem] leading-[28px] text-primary-richBlack font-[800]"
        )}
      >
        DOWNLOAD THE APP
      </h3>
      <div className="flex flex-col-reverse  md:flex-row justify-center items-center">
        <div className="w-full md:w-[50%]">
          <p
            className={cn(
              lato.className,
              "w-full pt-20 md:pt-0 md:w-[87%] mx-auto  md:mt-8 font-normal text-[1.25rem] leading-[25.49px] text-[#484848] my-12"
            )}
          >
            Experience the best of OreStore wherever you are with our mobile
            app. Shop your favorite products, track orders, and enjoy exclusive
            deals right at your fingertips. Download our app today and enjoy a
            seamless shopping experience.
          </p>
          <div className="md:mt-32 flex justify-center space-x-4">
            <Link href={"#"}>
              <Image
                src={"/iOS.png"}
                width={204}
